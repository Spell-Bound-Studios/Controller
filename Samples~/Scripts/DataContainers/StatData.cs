...
namespace SpellBound.Controller.Samples {
    ...
    public class StatData {
        ...
        [field: SerializeField, Range(0f, 20f)] public float lateralSteerAccel { get; private set; } = 8.0f;
        [field: SerializeField, Range(0f, 10f)] public float planarDrag { get; private set; } = 1.2f;
    }
}